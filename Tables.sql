...
CREATE TABLE alquiler (
    ...
    detalle_alquiler_vehiculo_v_placa   VARCHAR2(7 CHAR) NOT NULL,
...
CREATE TABLE compra (
    ...
    detalle_compra_V_ID               VARCHAR2(7 CHAR) NOT NULL,
    detalle_compra_M_ID               number NOT NULL,
    detalle_compra_MA_ID              number NOT NULL,
    sede_s_id                           number NOT NULL,
    -- claves primarias de la tabla
    PRIMARY KEY (c_id)
);
...
CREATE TABLE detalle_alquiler (
    ...
    -- claves primarias de la tabla
    PRIMARY KEY (da_id, vehiculo_v_placa, vehiculo_m_id, vehiculo_ma_id)
);
/
...
CREATE TABLE detalle_compra (
    ...
    vehiculo_ma_id     number NOT NULL,
    -- claves primarias de la tabla
    PRIMARY KEY (dc_id, vehiculo_v_placa, vehiculo_m_id, vehiculo_ma_id)
);
/
...
CREATE TABLE historico_promocion (
    ...
    vehiculo_ma_id      number NOT NULL,
    -- claves primarias de la tabla
    PRIMARY KEY (hp_id, promocion_p_id, vehiculo_v_placa, vehiculo_m_id, vehiculo_ma_id)
);
/
...
CREATE TABLE mantenimiento_vehiculo (
    ...
    -- claves primarias de la tabla
    PRIMARY KEY (man_id, vehiculo_v_placa, vehiculo_m_id, vehiculo_ma_id, mantenimiento_m_id, mantenimiento_tm_id)
);
/
CREATE TABLE marca (
...
CREATE TABLE vehiculo (
    ...
    sede_s_id             number NOT NULL,
    -- claves primarias de la tabla
    PRIMARY KEY (v_placa, modelo_m_id, modelo_marca_ma_id)
);
/
