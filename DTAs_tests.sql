...
create table prueba_ubicacion_geografica (
...
insert into persona values(default, informacion_personal(
    ...
    informacion_personal.veriricar_sexo('M'),
    'Transilvania' 
));
/

insert into prueba_ubicacion_geografica values(default, ubicacion_geografica(
    ubicacion_geografica.verificar_latitud(180.623215),
    ubicacion_geografica.verificar_longitud(180.623215),
    ubicacion_geografica.verificar_timestamp(TO_TIMESTAMP('2020/DEC/13 10:13:18', 'YYYY/MON/DD HH:MI:SS'))
));
/
...
select 
    pug.ubicacion.UG_Latitud,
    pug.ubicacion.UG_Longitud,
    pug.ubicacion.UG_Time_Stamp
from prueba_ubicacion_geografica pug;
/

-- drops de los objetos utilizados
drop table persona;
/

drop table prueba_ubicacion_geografica;
/
